...
export function MoodGrid({ selectedId, onSelect, onBack }: MoodGridProps) {
  ...
  return (
    <div className="relative w-full h-full flex flex-col overflow-hidden bg-[#0A0A0A]">
      ...
      {/* The Unified Map Engine */}
      <div className="flex-1 w-full h-full cursor-grab active:cursor-grabbing z-10">
        <TransformWrapper
          initialScale={0.4}
          minScale={0.15}
          maxScale={1.5}
        ...
        >
          <TransformComponent wrapperStyle={{ width: "100%", height: "100%" }}>
            ...
            {/* The Unified 2x2 Map */}
            <div className="grid grid-cols-2 w-[1800px] h-[1800px]">
              ...
              {QUADRANTS.map((quadrant, qIndex) => {
                ...
                return (
                  <div 
                    key={quadrant.key} 
                    className={cn(
                      "flex flex-wrap content-center p-8", // content-center keeps them clustered
