          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">The interactive navigation menu appears at the bottom center of your screen.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Tap on any of the four main navigation icons to switch between sections.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Watch the smooth transitions and active state indicators as you navigate.</p>
              </div>
            </div>
          </div>
        </div>
